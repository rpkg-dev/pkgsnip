...
- Report child-document-working-dir problem to knitr: `r getwd()` in Rmd built with `pal::build_readme()` returns the path to `rmd_snip_path()`-inserted knitr
  ...
  Neither did using a relative child path, i.e. `child = fs::path_rel(pkgsnip::rmd_snip_path("installation-notice_dev-version_gitlab.Rmd"))`.
