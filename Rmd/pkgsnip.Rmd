                          ...
                          purrr::map_chr(\(x) {
                            ...
                            result <-
                              ...
                              purrr::map_chr(\(s) {
                                ...
                                if (stringr::str_detect(as.character(s), stringr::fixed(";"))) {
                              ...
                              pal::when(length(.) == 0L ~ "",
                                        ~ pal::wrap_chr(., wrap = "`") |>
                                          cli::ansi_collapse(sep2 = ", ", last = sep2))
                          }))
}
```
...
#'   [`data_md_snips`][pkgsnip::data_md_snips] for an overview. If a required argument is not explicitly provided, it is searched for in the [parent
#'   frames][parent.frame].
#'
