...
- Report child-document-working-dir problem to knitr: `r getwd()` in Rmd built with `pal::build_readme()` returns the path to `rmd_snippet_path()`-inserted
  knitr child document `/home/salim/.by_pkg_mngr/r/pkgsnippets/snippets/`! WTF?!
  ...
  Neither did using a relative child path, i.e. `child = fs::path_rel(pkgsnippets::rmd_snippet_path("installation-notice_dev-version_gitlab.Rmd"))`.
